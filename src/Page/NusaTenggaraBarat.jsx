...
import Jawa2Img from '../assets/img/JawaImg2.png';

function NusaTenggaraBarat() {
          ...
          >
            <div className="w-full h-screen" style={{ backgroundImage: `url(${bgWalpp})` }}>
              ...
              <div className="flex items-center justify-center lg:mt-14 mt-44">
                <img src={Jawa2Img} alt="Sumatera img" className="lg:w-[550px] w-[600px] mx-auto" />
              </div>
            </div>
          </section>
...
export default NusaTenggaraBarat