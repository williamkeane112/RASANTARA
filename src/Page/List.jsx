...
function List() {
  ...
  switch (pulau) {
    case "sumatera":
      ...
      break;
    case "jawa":
      imageToShow = JawaImg2; // corrected variable name
      break;
    default:
      imageToShow = null;
      break;
  ...
  return (
    <>
      <div className={`grid ${isSmall ? "grid-cols-11" : ""} lg:grid-cols-12`}>
        ...
        <section className={`border-l lg:border-black lg:flex ${isSmall ? "col-span-6" : "lg:col-span-11"} ${
          ...
          <div className="w-full h-screen" style={{ backgroundImage: `url(${bgWalpp})` }}>
            ...
            <div className="flex items-center justify-center lg:mt-14 mt-44">
              <img src={imageToShow} alt="Pulau Image" className="lg:w-[550px] w-[600px] mx-auto" />
            </div>
          </div>
        </section>
      </div>
