...
function Detail() {
  ...
  return (
    <div className={`md:flex grid grid-cols-12 overflow-auto bg-gray-100`}>
      <div className={`fixed top-0 right-0 h-full w-full lg:col-span-1 col-span-12`}>
        <Sidebar />
      </div>
      {/* End Navbar */}

      {/* Main Content */}
      <div className="h-auto lg:col-span-7 col-span-12 lg:ml-9 mx-auto lg:mb-0 mb-10">
        <div className="mt-5 lg:w-[70%] w-[85%] mx-auto bg-gray-100 rounded-lg md:rounded-md shadow-2xl h-72">
          <iframe
        ...
        <div className="mt-10 ml-10 lg:w-full w-[85%] text-lg md:text-xl md:ml-24 font-bold font-sans tracking-wide">
          {data.makanan} | {data.daerah}
          {/* {data.tutorial} */}
        </div>

        <button className="mt-10 mx-auto md:hidden p-2 bg-[#2F7377] rounded-md flex items-center justify-between w-[85%]">
          <div>
        ...
        <div className="mx-auto mt-7 w-[85%] bg-gray-100 rounded-md  shadow-[4px_5px_9px_0.9px_rgba(0,0,0,0.4)] lg:w-[80%] h-auto text-left ">
          <div className="h-14 w-full row-span-1 flex justify-between mb-4">
          ...
          <div className="h-auto w-full ml-4 ">
            <h1 className="lg:w-10/12 w-[80%] pb-4 hyphens-auto text-justify mx-4 break-all">{detail.latarBelakang}</h1>
          </div>
        </div>

        <button className="mt-10 mx-auto md:hidden p-2 border-2 border-black lg:w-9/12 w-[85%] rounded-md flex items-center justify-between">
          <div>
        ...
        <div className="mx-auto mt-7 w-[85%] shadow-[4px_5px_9px_0.9px_rgba(0,0,0,0.4)] bg-gray-100 rounded-md lg:w-[80%] h-auto ">
          ...
          <div className="h-auto w-full ml-4 mb-4 pb-4">
            <ul className="lg:w-11/12 w-[80%] list-disc ml-5">
        ...
        <div className="mx-auto mt-7 bg-gray-100 rounded-md shadow-[4px_5px_9px_0.9px_rgba(0,0,0,0.4)] lg:w-[80%] w-[85%] h-auto ">
          ...
          <div className="h-auto w-full ml-4 mb-4">
            <ol className="lg:w-11/12 w-[80%] list-decimal ml-5 space-y-2">
      ...
      <div className="hidden h-56 w-full md:h-screen col-span-4 md:flex md:justify-center md:items-start -ml-20">
        <div className="w-full mx-2 ">
          <div className="mx-5 md:mx-0 mt-5 h-48 md:mt-10 md:h-60 bg-gray-150 rounded-md  shadow-[0_6px_4px_0.9px_rgba(0,0,0,0.4)] flex flex-col justify-evenly items-center">
            <Link to={-1} className="p-2 bg-[#2F7377] w-3/4 rounded-md flex items-center justify-between">
              <div>
            ...
            <button className="p-2 border border-black w-3/4 rounded-md flex items-center justify-between">
              <div>
