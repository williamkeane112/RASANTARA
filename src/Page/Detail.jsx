    ...
    return (
        <div className="flex overflow-auto bg-gray-100">
            ...
            <div className="mt-7 flex flex-col items-center">
                ...
                <img src={save} alt="Icon Save Menu" className="w-[25px]" />
                <span className="lg:text-[13px] text-sm">Tersimpan</span>
                </button>
                <button className="flex flex-col items-center">
                <img src={Latters} alt="Icon Latters Menu" className="w-[25px]" />
            ...
            <div className="h-auto w-11/12 flex">
                ...
                <div className="h-auto w-9/12 flex flex-col">
                    <div className="mx-auto mt-10 bg-gray-100 rounded-md shadow-lg w-11/12 h-72">
                        <iframe className="p-4 h-full w-full" width="560" height="315" src="https://www.youtube.com/embed/nIE7Hg2YK4Y?si=2QxZJbN_MgIlf5z3" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                    ...
                    <div className="mx-auto mt-20 bg-gray-100 rounded-md shadow-lg w-11/12 h-auto mb-4">
                        ...
                        <div className="h-auto w-full ml-4 mb-4">
                            <ol className="w-11/12 list-decimal ml-5 space-y-6"><li>Masukkan semua bahan kecuali tepung tapioka atau sagu, ke dalam food processor atau chopper, giling hingga halus.</li>
                    ...
                    <div className="fixed w-2/12">
                        <div className="mt-10 h-60 bg-gray-150 rounded-md shadow-lg flex flex-col justify-evenly items-center">
                            <Link to='/sumatera' className="p-2 bg-gray-500 w-3/4 rounded-md flex items-center justify-between">
                                <div>
                                    <svg className="text-white size-6" stroke="CurrentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M12.707 17.293L8.414 13 18 13 18 11 8.414 11 12.707 6.707 11.293 5.293 4.586 12 11.293 18.707z"></path></svg>
                                </div>
                            ...
                            <button className="p-2 border-2 border-black w-3/4 rounded-md flex items-center justify-between">
                                <div>
                                    <svg className="size-6" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M8 12l5 3V3a2 2 0 00-2-2H5a2 2 0 00-2 2v12l5-3zm-4 1.234l4-2.4 4 2.4V3a1 1 0 00-1-1H5a1 1 0 00-1 1v10.234z" clipRule="evenodd"></path></svg>
                                </div>
